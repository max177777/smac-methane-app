...
GENERAL_PATTERNS = [
    ...
    (re.compile(r"who are you|what are you|what is smac", re.I),
     "SMAC stands for **Subnational Methane Atlas & Chat**. It's a prototype that pairs real "
     "Climate TRACE methane data (11 countries, 280+ subnational units, 48 months) with a chat "
     "interface that reasons through the data and produces structured policy guidance.\n\n"
     "This tab — the General Assistant — is the off-topic side. The Methane Specialist tab on "
     "the left is where the data work happens."),
